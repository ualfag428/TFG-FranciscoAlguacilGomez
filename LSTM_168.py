...
def create_windows_multi(dataset, window_size=168, horizon=1, salto=1):  # 24 → 168
    X, y = [], []
...
print("\nPredicción autoregresiva completada.")
...
plt.tight_layout()
plt.savefig("LSTM_puro_168h.png", dpi=300, bbox_inches='tight')
plt.show()
