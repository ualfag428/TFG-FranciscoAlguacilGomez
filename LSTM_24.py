...
print(f"\n INICIANDO PREDICCIÓN  ({N_PASOS} pasos, {N_MC} trayectorias MC)")
...
plt.tight_layout()
plt.savefig("LSTM_puro_24h.png", dpi=300, bbox_inches='tight')
plt.show()
...
print(f"\n{'='*80}")
print("TABLA 4 — CALIBRACIÓN BAYESIANA")
print(f"{'='*80}")
